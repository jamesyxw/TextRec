...
train_data_pp = data_pp;
load('test_grayscale.mat');
test_data_pp = data_pp;
...
if pca_num ~= 0
	...
	save(char(strcat( 'train_grayscale_pca_',num2str(pca_num), '.mat')),'train_data_pp');
	save(char(strcat( 'test_grayscale_pca_',num2str(pca_num), '.mat')),'test_data_pp');
end 
...
ann_model.net = net;
ann_model.tr = tr;
save(char(strcat( 'ann_grayscale',array2str(numHidden),'_pca_', num2str(pca_num), '.mat')), 'ann_model'); 
